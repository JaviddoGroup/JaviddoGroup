...
document.addEventListener('DOMContentLoaded', function () {
    ...
    setTimeout(function () {
        videoOverlay.style.display = 'none'; // Скрыть GIF оверлей
        document.documentElement.classList.add('html-active-scroll'); // Добавить класс к <html> элементу
        document.getElementById('main-content').style.display = 'block'; // Показать основной контент
    }, 4480); // Таймер на 5 секунд
});
